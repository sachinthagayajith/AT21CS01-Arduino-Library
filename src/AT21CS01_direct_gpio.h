#ifndef AT21CS01_Direct_GPIO_h
#define AT21CS01_Direct_GPIO_h
...
// If you have trouble with AT21CS01 on Arduino Due, please check the
// status of delayMicroseconds() before reporting a bug in AT21CS01!
...
#warning "AT21CS01. RP2040 in Fallback mode. Using API calls for pinMode,digitalRead and digitalWrite."
...
#define DIRECT_MODE_INPUT(base, pin)    pinMode(pin,INPUT)
#define DIRECT_MODE_OUTPUT(base, pin)   pinMode(pin,OUTPUT)
#warning "AT21CS01. Fallback mode. Using API calls for pinMode,digitalRead and digitalWrite. Operation of this library is not guaranteed on this architecture."
